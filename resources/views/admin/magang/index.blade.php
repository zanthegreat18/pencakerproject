...
<head>
    ...
    <title>Magang - Admin AntiNganggur</title>
    ...
    <main class="flex-1 bg-gradient-to-br from-purple-100 via-white to-blue-100 text-gray-900 flex flex-col">
        ...
        <div class="p-10">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold">Magang Tersedia</h1>
            ...
            <div class="overflow-x-auto rounded shadow-lg">
                <table class="w-full table-auto border border-gray-200 bg-white text-sm text-gray-800">
                    ...
                    <tbody>
                        @forelse ($magangs as $m)
                            <tr class="border-t border-gray-200 hover:bg-purple-50 transition">
                                ...
                                <td class="p-3 text-center space-x-2">
                                    <a href="{{ route('admin.magang.edit', $m->id) }}"
                                       class="text-blue-500 hover:underline">Edit</a>
                                    <form action="{{ route('admin.magang.destroy', $m->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button onclick="return confirm('Hapus data magang ini?')"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="p-4 text-center text-gray-400">Belum ada data magang.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
